...
1. targets that have been observed before easily (e.g. R < 15.5, on-axis tip-tilt-focus guide stars),
2. targets that have been observed before, but are risky (e.g. 15.5 < R < 17.5 guide stars, or bright off axis),
3. targets that could not be observed before (e.g. IR-only TT stars, R>17.5 mag)
